...
class Ion_auth_model extends CI_Model
{
	...
	**/
	 ...
	 *
	 * @return bool
	 * @author shakespeare2000
	 **/
	public function unset_session()
	{
		$this->trigger_events('pre_unset_session');

		$this->session->unset_userdata(array('identity', $this->identity_column, 'email', 'user_id', 'old_last_login'));

		$this->trigger_events('post_unset_session');
