...
INSERT INTO users (id, ip_address, username, password, otp, otp_login_code, otp_backup_codes, salt, email, activation_code, forgotten_password_code, created_on, last_login, active, first_name, last_name, company, phone)
